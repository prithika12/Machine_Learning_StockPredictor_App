...
# Container 1
st.sidebar.markdown("## News Container 1")
st.sidebar.write("News content goes here...")

# Container 2
st.sidebar.markdown("## News Container 2")
st.sidebar.write("More news content goes here...")
