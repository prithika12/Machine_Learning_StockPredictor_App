...
def fetch_cnbc_news():
    feed_url = "https://www.cnbc.com/id/100003114/device/rss/rss.html" # CNBC RSS feed URL
...
# Container 1 - CNBC News
with col1:
    st.sidebar.expander("CNBC", expanded=True)
    cnbc_news = fetch_cnbc_news()
    for entry in cnbc_news[:5]:  # Display the top 5 news articles
