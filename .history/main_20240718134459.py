...
with col1.expander("News Container 1", expanded=True):
    selected_symbol1 = st.selectbox('Select stock symbol', stocks)
    if selected_symbol1 != "Choose an option":
        news1 = fetch_stock_news(selected_symbol1)
...
with col2.expander("News Container 2", expanded=True):
    selected_symbol2 = st.selectbox('Select stock symbol', stocks)
    if selected_symbol2 != "Choose an option":
        news2 = fetch_stock_news(selected_symbol2)
